...
# Custom matchers Added by Ahmad
custom_matchers = ["include", "contain", "be_into", "be_greater_than", "be_greater_than_or_equal_to", "be_less_than", "be_less_than_or_equal_to", "be_thrown_by", "include_in_any_order", "include_all_of", "include_any_of", "be_kind_of", "be_instance_of", "start_with", "end_with", "equal_to_ignoring_case", "into", "greater_than", "greater_than_or_equal_to", "less_than", "less_than_or_equal_to", "thrown_by", "in_any_order", "all_of", "any_of", "kind_of", "ended_with", 'be', 'equal_to', 'throw', 'be_like', 'have', 'have_at_least', 'have_at_most', 'respond_to', 'close_to', 'change', 'like', 'include_keys', 'include_values', 'be_empty', 'have_same_attribute_values_as']

# Globally defined names which are not attributes of the builtins module, or
# are only present on some platforms.
_MAGIC_GLOBALS = ['__file__', '__builtins__', 'WindowsError'] + custom_matchers
